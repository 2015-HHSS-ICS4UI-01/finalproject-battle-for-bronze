...
//                 }
        ...
        if (horizontal == true){
            ...
            for (int i = 1; i <= tempF; i++) {
                ...
                if (temp2 != null && temp.getTile().getId() != 187){
...
//                        RedTilesOnMapP1 = false;
//                    }
//                    else if(clickedCard.getAttack() > /*whatever*/.getDefense && /*whatever*/.getAttack() > clickedCard.getDefense()){
...
//                }
        ...
        if (horizontal2 == true){
            ...
            for (int i = 1; i <= tempF; i++) {
                ...
                if (temp2 != null  && temp.getTile().getId() != 187 && temp.getTile().getId() != 186){
                   if (temp2.getTile().getId() != 187) {
                    temp2.setTile(gameSet.getTile(188));
                    } 
                } else {
                    temp.setTile(gameSet.getTile(205));
