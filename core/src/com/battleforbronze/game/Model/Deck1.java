...
public class Deck1 {
    ...
    public Deck1() {
        ...
        deckOne.add(new Card("Mr L", 1, 2, 1, 1));
        deckOne.add(new Card("Yi", 2, 1, 1, 1));
        deckOne.add(new Card("Chad", 3, 1, 1, 2));
        deckOne.add(new Card("Gestle", 1, 2, 3, 2));
        deckOne.add(new Card("Woods", 4, 1, 1, 2));
        deckOne.add(new Card("Surick", 1, 1, 6, 3));
        deckOne.add(new Card("Jax", 5, 2, 2, 3));
        deckOne.add(new Card("Phaard", 1, 5, 2, 3));
        deckOne.add(new Card("Clap", 3, 3, 2, 4));
        deckOne.add(new Card("Azzer", 2, 3, 3, 4));
        deckOne.add(new Card("Lee", 5, 1, 1, 4));
        deckOne.add(new Card("P23c", 1, 1, 6, 4));
        deckOne.add(new Card("LION", 5, 2, 2, 5));
        deckOne.add(new Card("Echo", 2, 5, 2, 5));
        deckOne.add(new Card("Tim", 5, 5, 2, 6));
        deckOne.add(new Card("XxOptic", 2, 6, 4, 6));
        deckOne.add(new Card("Azir", 1, 1, 7, 7));
        deckOne.add(new Card("Zed", 3, 5, 3, 7));
        deckOne.add(new Card("Phlare", 8, 3, 3, 8));
